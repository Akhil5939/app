...
export default function App() {
  ...
  const fetchUser = () => {
    fetch('https://dummy.restapiexample.com/api/v1/employee/1${id}')
  ...
  const UpdateUser = () => {
    fetch("https://dummy.restapiexample.com/api/v1/update/21" + id, {
      method: "PUT",
      body: {
        name: name,
        job: job,
  ...
  const DeleteUser = () => {
    fetch("https://dummy.restapiexample.com/api/v1/delete/2" + id, {
      method: "DELETE",
    }).then((response) => {
